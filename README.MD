...
- **Configuration de chaque service** : `/service/env` configuration de chaque service (ex : [http://localhost:9999/customer-service/dev](http://localhost:9999/customer-service/dev))
